...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-gradient-to-br from-amber-50 to-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="text-sm text-blue-800 font-medium mb-2">SIMPLIFY YOUR LEGAL WORK</div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Legal Research and Briefing Software</h1>
