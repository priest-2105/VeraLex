        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-1">
              <div className="text-xl font-bold mb-4">Vera<span className="text-primary">Lex</span></div>
              <p className="text-gray-300 mb-4">Connecting clients with the right legal representation.</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/auth/signin" className="text-gray-300 hover:text-primary">Sign In</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <a href="mailto:info@veralex.com" className="text-gray-300 hover:text-primary">info@veralex.com</a>
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+11234567890" className="text-gray-300 hover:text-primary">+1 (123) 456-7890</a>
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-gray-300">123 Legal Street, Suite 100, Anytown, USA</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} VeraLex. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
